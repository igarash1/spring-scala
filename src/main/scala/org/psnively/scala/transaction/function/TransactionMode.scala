 ...
 * [[org.psnively.scala.transaction.function.AspectJTransactionMode]]
 * and
 * [[org.psnively.scala.transaction.function.ProxyTransactionMode]]
 *
 ...
 * `org.psnively.scala.context.function.TransactionSupport.enableTransactionManagement()`
 *
 * @author Maciej Zientarski
 * @since 1.0
 */
 ...
 * parameter of [[org.psnively.scala.transaction.function.TransactionSupport.enableTransactionManagement( )]]
